...
Gem::Specification.new do |s|
   ...
   s.files = ["app/models", "app/models/disk.rb", "app/models/file_system.rb", "app/models/host.rb", "app/models/load.rb", "app/models/memory.rb", "lib/base.rb", "lib/client_commands.rb", "config.ru", "README.md", "views/host.haml", "views/layout.haml", "views/main.haml", "views/style.sass", "config/thin.yml", "server.rb", "client.rb", "bin/dognotgod", "bin/dognotgod-client", "public/javascripts/jquery.simplemodal-1.2.3.min.js", "public/images/blossom/48x48/world_globe.png", "public/images/coquette/24x24/green_button.png", "public/images/coquette/16x16/green_button.png", "public/images/blossom/32x32/delete_item.png", "public/images/blossom/48x48/user.png", "public/images/blossom/32x32/process.png", "public/images/blossom/32x32/chart.png", "public/images/blossom/32x32/hard_disk.png"]
